if engine.ActiveGamemode() != "ultimateph" then return end

local CATEGORY_NAME = "UltimatePH"
...
local autoTauntDelay = ulx.command(CATEGORY_NAME, "ulx ph_auto_taunt_delay", ulx.ultimatephAutoTauntDelay, "!ph_auto_taunt_delay")
